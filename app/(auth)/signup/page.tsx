...
export default function SignupFormDemo() {
  ...
  return (
    <div className="shadow-input mx-auto w-full h-[550px] max-w-md mt-6    rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black">
      ...
      <form className="my-8" onSubmit={handleSubmit}>
        <div className="mb-4 flex flex-col space-y-2 md:flex-row md:space-y-0 md:space-x-2">
          <LabelInputContainer>
            ...
            <Input id="firstname" placeholder="Akash" type="text" />
          </LabelInputContainer>
          <LabelInputContainer>
        ...
        <LabelInputContainer className="mb-4">
          ...
          <Input id="email" placeholder="inventra@gmail.com" type="email" />
        </LabelInputContainer>
        <LabelInputContainer className="mb-4">
